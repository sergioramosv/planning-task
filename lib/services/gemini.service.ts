...
// ============================================================
// FUNCTION DECLARATIONS (21 tools)
// ============================================================
    ...
    functionDeclarations: [
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: { projectId: { type: SchemaType.STRING, description: 'ID del proyecto' } },
          required: ['projectId'],
        },
      },
      ...
      // --- TASKS ---
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            status: { type: SchemaType.STRING, description: 'Filtrar por estado: to-do, in-progress, to-validate, validated, done' },
      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            acceptanceCriteria: { type: SchemaType.ARRAY, items: { type: SchemaType.STRING }, description: 'Criterios de aceptacion' },
          ...
          required: ['title', 'projectId', 'userStoryWho', 'userStoryWhat', 'userStoryWhy', 'acceptanceCriteria', 'bizPoints', 'devPoints'],
        },
      },
      {
        name: 'update_task',
      ...
      // --- MEMBERS ---
      {
        ...
        parameters: {
          type: SchemaType.OBJECT,
          properties: { projectId: { type: SchemaType.STRING } },
          required: ['projectId'],
        },
      },
      ...
      // --- ANALYTICS ---
      {
        ...
        description: 'Obtiene metricas del proyecto: tareas por estado, porcentaje completado, carga de developers, bugs',
        parameters: {
          type: SchemaType.OBJECT,
          properties: { projectId: { type: SchemaType.STRING } },
          required: ['projectId'],
      ...
      },
      {
        ...
        parameters: {
          type: SchemaType.OBJECT,
          properties: { sprintId: { type: SchemaType.STRING } },
          required: ['sprintId'],
        },
      },
      {
...
export async function executeFunctionCall(
  ...
  switch (name) {
    ...
    case 'create_bug':
      return AiTools.createBug({ ...args, projectId: args.projectId || projectId }, uid, userName)
    case 'update_bug':
